...
// ---------------------------------------------------------------------------
// ISSUE-356 再発検定: ライブプレビュー（段階 5-C-3）は表示モードを壊さない
// ---------------------------------------------------------------------------
//
// ISSUE-356 の 3 症状（透明ローソクが不透明へ戻る／分析 tint が消える／ペア外の減光色だけ旧色で
...
test('ISSUE-356 再発検定: プレビューの色差し替えは透明ローソク・分析 tint を壊さない', () => {
...
test('ISSUE-356 再発検定: プレビュー解除で元の色へ戻ってもモードは保たれる', () => {
