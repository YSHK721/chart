...
test('listIndicators returns the 28 registered indicators (基本4 + btlm_trail + btlm_trail_marod + ma_marod + cvfe + period_hl + ytd_hl + profit_* 15 + market_profile + tickvol_bands + tickvol)', () => {
