...
//
//   level / muted の 2 語は係数を**混合比から対地コントラスト比の目標へ**改めた（ISSUE-345）。
...
// === level / muted は混合比ではなく「対地コントラスト比の目標」で持つ（ISSUE-345 の是正）===
//
...
//   8bit の量子化だけで割り得る（ISSUE-345 が指摘した「余裕の薄さ」そのもの）。max(実測 3.217,
