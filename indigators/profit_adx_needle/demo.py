"""デモ: 合成 OHLC に ADX_NEEDLE を当て matplotlib PNG を生成する。
...
from src.plot import plot_adx_needle  # noqa: E402
...
def main() -> None:
    ...
    out = plot_adx_needle(
        df,
        out_path=str(Path(__file__).parent / "profit_adx_needle_demo.png"),
        period=6,
        title="PRO!fit_ADX_NEEDLE (demo / synthetic OHLC)",
    )
    print("saved:", out)
