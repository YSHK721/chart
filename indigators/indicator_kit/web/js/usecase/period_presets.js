...
// ---------------------------------------------------------------------------
// 換算表 v2（設計 §4.3 v2・実測値・2026-07-29 計測）
// ---------------------------------------------------------------------------
// 目的     : 提示できる期間の刻みが粗く選択肢が少ないというユーザー要求（2026-07-29）への対応。
//            v1 の 11 単位に中間刻み 9 単位（2h/6h/12h/2d/3d/2w/3w/2mo/9mo）を**加法**した 20 単位。
// 計測     : v1 と同一手順・同一定義（§4.1／§11・tools/period_presets_measure.py）で全単位を再計測。
// 実測期間 : 日中足（1m〜4h）= 2021-01-01 以降 ／ 1D/1W/1M = 2015-01-01 以降
// 版管理   : v1 は削除しない（§4.4-3）。保存済みパラメータは本数で保存されているため版上げで
//            遡って変化しない。v1 との差は右端サンプル格子の移動による ±（大きな本数のセルほど
//            絶対差が出る。例 1m の '1mo' 27505→27515）で、提示対象（≤1500 本）のセルは
//            1D '1w'=5・1h '1w'=115 等いずれも v1 と一致するか ±1 以内。
const TABLE_V2 = Object.freeze({
  jp225_tick: Object.freeze({
    '1m': Object.freeze({ '1h': 60, '2h': 120, '4h': 237, '6h': 352, '12h': 615, '1d': 1281, '2d': 2455, '3d': 3107, '1w': 6424, '2w': 12788, '3w': 19118, '1mo': 27515, '2mo': 54692, '3mo': 82563, '6mo': 164817, '9mo': 246610, '1y': 328975, '2y': 645583, '3y': 976817, '5y': 1634919 }),
    '5m': Object.freeze({ '1h': 12, '2h': 24, '4h': 48, '6h': 72, '12h': 131, '1d': 266, '2d': 528, '3d': 646, '1w': 1329, '2w': 2649, '3w': 3961, '1mo': 5730, '2mo': 11338, '3mo': 17098, '6mo': 34009, '9mo': 51081, '1y': 68151, '2y': 136155, '3y': 204186, '5y': 340504 }),
    '15m': Object.freeze({ '1h': 4, '2h': 8, '4h': 16, '6h': 24, '12h': 44, '1d': 89, '2d': 178, '3d': 216, '1w': 445, '2w': 889, '3w': 1322, '1mo': 1919, '2mo': 3798, '3mo': 5729, '6mo': 11400, '9mo': 17096, '1y': 22814, '2y': 45584, '3y': 68369, '5y': 113985 }),
    '30m': Object.freeze({ '1h': 2, '2h': 4, '4h': 8, '6h': 12, '12h': 22, '1d': 45, '2d': 90, '3d': 108, '1w': 225, '2w': 450, '3w': 668, '1mo': 969, '2mo': 1921, '3mo': 2897, '6mo': 5765, '9mo': 8646, '1y': 11538, '2y': 23052, '3y': 34576, '5y': 57645 }),
    '1h': Object.freeze({ '1h': 1, '2h': 2, '4h': 4, '6h': 6, '12h': 11, '1d': 23, '2d': 46, '3d': 56, '1w': 115, '2w': 230, '3w': 341, '1mo': 495, '2mo': 981, '3mo': 1481, '6mo': 2947, '9mo': 4419, '1y': 5895, '2y': 11781, '3y': 17669, '5y': 29456 }),
    '4h': Object.freeze({ '4h': 1, '6h': 1, '12h': 3, '1d': 6, '2d': 12, '3d': 15, '1w': 31, '2w': 62, '3w': 93, '1mo': 134, '2mo': 266, '3mo': 401, '6mo': 798, '9mo': 1197, '1y': 1597, '2y': 3195, '3y': 4789, '5y': 7985 }),
    '1D': Object.freeze({ '1d': 1, '2d': 2, '3d': 2, '1w': 5, '2w': 10, '3w': 15, '1mo': 21, '2mo': 43, '3mo': 65, '6mo': 129, '9mo': 193, '1y': 258, '2y': 516, '3y': 774, '5y': 1291 }),
    '1W': Object.freeze({ '1w': 1, '2w': 2, '3w': 3, '1mo': 4, '2mo': 8, '3mo': 13, '6mo': 26, '9mo': 39, '1y': 52, '2y': 104, '3y': 156, '5y': 260 }),
    '1M': Object.freeze({ '1mo': 1, '2mo': 2, '3mo': 3, '6mo': 6, '9mo': 9, '1y': 12, '2y': 24, '3y': 36, '5y': 60 }),
  }),
});

// 現行版（引き当てに使う表）。版上げ時はここを差し替え、旧版の定数は残す（§4.4-3）。
export const PRESET_TABLE_VERSION = 'v2';
const ACTIVE_TABLE = TABLE_V2;

// 単位の並び（短い順・§6.1-4 の「期間の短い順」の唯一源）。
const UNIT_ORDER = Object.freeze([
  '1h', '2h', '4h', '6h', '12h',
  '1d', '2d', '3d',
  '1w', '2w', '3w',
  '1mo', '2mo', '3mo', '6mo', '9mo',
...
const UNIT_LABELS = Object.freeze({
  '1h': '1時間', '2h': '2時間', '4h': '4時間', '6h': '6時間', '12h': '12時間',
  '1d': '1日', '2d': '2日', '3d': '3日',
  '1w': '1週間', '2w': '2週間', '3w': '3週間',
  '1mo': '1ヶ月', '2mo': '2ヶ月', '3mo': '3ヶ月', '6mo': '6ヶ月', '9mo': '9ヶ月',
  '1y': '1年', '2y': '2年', '3y': '3年', '5y': '5年',
});

// 時間足 → バー秒長（名目）は台帳（Python 生成物 tf_ledger_generated.js → tf_meta.js）から採る。
//   かつてここに同値の手書き dict（TF_SEC）を置いていたが、それは台帳の第 2 定義であり、
...
// 提示件数の上限（§6.1-4）。
//   v1 は 5 件だったが「選択肢が少ない」というユーザー要求（2026-07-29）により、表 v2 の
//   全候補を出せる値へ引き上げる（実測: 候補数の最大は 1h 足・1D 足の 13 件）。上限は
//   暴走防止の安全弁として残す。ポップは max-height 60vh / overflow-y:auto のため行数が
//   増えてもレイアウトは崩れない（CSS 変更不要）。
export const MAX_PRESETS = 14;
...
export function tableRow(datasetRef, timeframe) {
  const byRef = ACTIVE_TABLE[datasetRef];
  if (!byRef) {
    return null;
  }
...
export function presetsFor({
  ...
  for (const unit of UNIT_ORDER) {
    ...
    // 表 v2 の細かい刻みでは、時間足によって異なる期間が同じ本数へ落ちる
    //   （例: 1D 足の「2日」も「3日」も 2 本）。同一本数の候補は**期間の短い方だけ**を
    //   提示する（UNIT_ORDER は短い順＝先に来た方を採る＝決定論的）。同じ値を選ぶだけの
    //   行が並ぶのを避ける。
    if (seenBars.has(bars)) {
      continue;
    }
    seenBars.add(bars);
...
export function parsePeriodInput(text, {
  ...
  if (hit.kind === 'min') {
    const sec = TF_BAR_SEC[timeframe];
    if (!sec) {
