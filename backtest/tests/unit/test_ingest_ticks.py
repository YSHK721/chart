...
def test_to_canonical_ticks_maps_columns_to_tick_columns():
    from backtest.adapter.repository._tick_frame import TICK_COLUMNS
    from backtest.tools.ingest_ticks import to_canonical_ticks
...
def test_ingest_raw_parquet_round_trips_written_rows_via_load_ticks(tmp_path):
    ...
    from backtest.tools.ingest_ticks import ingest_raw_parquet
