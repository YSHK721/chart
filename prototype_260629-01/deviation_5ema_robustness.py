#!/usr/bin/env python3
"""5EMA 下方乖離シグナルの期間ロバスト性検定  JP225 日足
...
def run():
    ...
    print("=" * 88)
    print("5EMA 下方乖離シグナル 期間ロバスト性検定  JP225 日足  M=%d" % M_RUNS)
    print("=" * 88)
    ...
    print("\n" + "-" * 88)
    _verdict(summary)
    json.dump(summary, open(os.path.join(OUT, "deviation_5ema_robustness.json"), "w"),
              ensure_ascii=False, indent=2)
    print(f"\n出力: {OUT}/deviation_5ema_robustness.json")
