...
> **【状態注記 2026-07-19】** 旧版クラス図にあった `IndicatorDef.validateParams`（ConstraintEvaluator への委譲）は死滅コード監査で撤去済み（2026-07-18・コミット b62bcc3）。検証経路は FormModel → `ConstraintEvaluator.evaluate` の直呼びに一本化されている。
