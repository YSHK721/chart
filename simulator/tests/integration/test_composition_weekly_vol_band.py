...
def _write_csv(path: Path) -> Path:
    ...
    rows = [
        ...
        "2024-02-12T00:00:00,100.0,100.5,99.5,100.2,1.0,0",
        "2024-02-12T00:01:00,100.2,100.8,100.0,100.6,1.0,0",
        "2024-02-12T00:02:00,100.6,101.0,100.4,100.9,1.0,0",
    ]
    path.write_text("\n".join(rows) + "\n", encoding="utf-8")
    return path
...
class TestCompositionWeeklyVolBand:
    ...
    def test_tc24051901_path_unchanged(self, tmp_path):
        ...
        rows = [
            "time,open,high,low,close,volume,spread",
            "2024-01-01T00:00:00,1.1,1.101,1.099,1.0995,1.0,0",
            "2024-01-01T00:01:00,1.1,1.101,1.0985,1.099,1.0,0",
            "2024-01-01T00:02:00,1.099,1.105,1.099,1.104,1.0,0",
        ]
        csv.write_text("\n".join(rows) + "\n", encoding="utf-8")
        # Act
