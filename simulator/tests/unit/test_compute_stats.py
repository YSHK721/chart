...
def test_expected_payoff_matches_metrics_12():
    from simulator.usecase.compute_stats import expected_payoff
...
def test_sharpe_ratio_uses_population_std_ddof0():
    ...
    from simulator.usecase.compute_stats import sharpe_ratio
...
def test_balance_dd_relative_percent_matches_metrics_12():
    from simulator.usecase.compute_stats import balance_dd_relative_percent
...
def test_balance_dd_relative_amount_matches_metrics_12():
    from simulator.usecase.compute_stats import balance_dd_relative_amount
...
def test_z_score_matches_mt5_formula():
    ...
    from simulator.usecase.compute_stats import z_score
...
def test_largest_profit_and_loss_match_metrics_12():
    from simulator.usecase.compute_stats import largest_loss_trade, largest_profit_trade
...
def test_average_profit_and_loss_trade_match_metrics_12():
    from simulator.usecase.compute_stats import average_loss_trade, average_profit_trade
...
def test_average_consecutive_losses_uses_run_member_count_not_count_loss():
    ...
    #   正: N_l/K_l = 3/2 = 1.5。
    from simulator.usecase.compute_stats import average_consecutive_losses
...
def test_is_count_win_counts_zero_pnl_as_win():
    ...
    from simulator.usecase.compute_stats import is_count_win
...
def test_compute_stats_does_not_import_pandas_at_module_level_for_purity():
    ...
    import simulator.usecase.compute_stats as cs
...
def test_compute_stats_recovery_is_equity_based_when_curve_supplied():
    ...
    from simulator.usecase.compute_stats import compute_stats, recovery_factor_equity
