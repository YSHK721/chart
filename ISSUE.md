...
- **検証**: MP api 220・MP web 273・UI web 530/532 緑。実UI（8139）: gear に表示幅(bp)のみ（旧解像度UI消滅）・dispbp=3 で実URL barw=20.4222（=3bp×終値68,074）を確認。zp b1 znull ウォーム実行→完了後に zp 実UI確認。
