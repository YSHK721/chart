...
- **ステータス**: IN_PROGRESS（**実装済み**・feature/issue-449-price-level-reach-sheet・マージ待ち。コードレビュー指摘の是正まで完了）
...
- **ステータス**: OPEN（2026-08-29 起票・**設計中／実装未着手**）
...
- **ステータス**: OPEN（2026-08-29 起票・**設計確定／実装未着手**。要承認 1 点は 2026-08-29 承認済み）
...
- **ステータス**: OPEN（2026-08-29 起票・**是正案提示／承認待ち**）
