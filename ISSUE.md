...
- **実 UI 検証（2026-07-30・ライブ 8000・NI225 5 分足）**: 各バーにローソク足幅の水平ダッシュが並ぶことを `barSpacing=6` へ拡大して目視確認（既定の `barSpacing=0.5` ではローソク自体が 0.5px 幅のため点に見える）。コンソールエラー 0 件。web 920 passed / API 438 passed / cvfe 122 passed。
