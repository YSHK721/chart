...
**段階 2: ポート開放後の実測** — VM で `python -m http.server 8765 --bind 0.0.0.0` を起動し、
受信を `-RemoteAddress 172.16.162.0/24` に限定して許可した状態で:
...
1. `python -m http.server` を Ctrl-C で停止
2. `Remove-NetFirewallRule -DisplayName "MT5 bridge test"`
