...
- **ステータス**: IN_PROGRESS（2026-08-28 起票・第 1 段の是正を実施済み・値一致を実測で確認）
...
是正後も MTF 1 本あたり 0.3〜1.1 秒が残る（1m/5m 1,142 ms・1m/1M 986 ms）。起動時に MTF が
6〜9 本ある時間足では依然として数秒。残りの内訳を計測して起票する。
